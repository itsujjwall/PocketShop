...
public class AdminUserProductActivity extends AppCompatActivity {
    ...
    private DatabaseReference CartListProductRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CartListProductRef= FirebaseDatabase.getInstance().getReference().child("Cart List").child("Admin View")
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Cart> options=new FirebaseRecyclerOptions.Builder<Cart>()
                .setQuery(CartListProductRef,Cart.class).build();
